#!/usr/bin/env python3
"""Parse trivy-results/strata-asm-runner.json and write a Markdown summary next to it."""
...
INPUT = Path("trivy-results/strata-asm-runner.json")
OUTPUT = Path("trivy-results/strata-asm-runner.md")
