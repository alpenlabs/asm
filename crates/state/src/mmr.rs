...
use strata_asm_manifest_types::{ASM_MANIFEST_MMR_PREFILL_LEAF, AsmManifest, AsmManifestHash};
...
impl AsmHistoryAccumulatorState {
    ...
    ///
    /// The MMR is prefilled with [`ASM_MANIFEST_MMR_PREFILL_LEAF`] for every L1 block
    ...
    pub fn new(genesis_height: u64) -> Self {
        ...
        let manifest_mmr = <Mmr64B32 as Mmr<AsmHasher>>::new_repeated(
