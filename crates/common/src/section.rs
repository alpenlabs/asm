...
mod tests {
    ...
    use super::*;
    use crate::{
        HeaderVerificationState, MsgRelayer, NullMsg, SectionStateVersion, SubprotocolId,
    ...
    #[test]
    fn try_to_state_rejects_wrong_metadata() {
        let mut section =
            SectionState::new(TEST_ID + 1, 0, 7u64.as_ssz_bytes()).expect("fits capacity");
        assert!(matches!(
