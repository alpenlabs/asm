...
use strata_asm_proto_bridge_v1_state::AssignmentEntry;
// Re-exported so test modules keep finding the state-building helpers here.
pub(crate) use strata_asm_proto_bridge_v1_state::test_utils::{
