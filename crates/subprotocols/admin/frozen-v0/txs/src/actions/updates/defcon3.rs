...
/// the bridge to activate its safe harbour after the timelock configured in
/// [`ConfirmationDepths::defcon3`](strata_asm_admin_types::ConfirmationDepths). Carries no payload.
